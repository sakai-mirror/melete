...
<!--replace with new link part Begin -->
					...
					<tr><td height="20" colspan="2"> 
						<h:outputText id="editLTIText_6" value="#{msgs.addmodulesections_lti_title}" /><h:outputText value="*" styleClass="required"/>
			 			<h:outputText id="editLTIText_7" value=" " styleClass="ExtraPaddingClass"/>
			 			<h:outputText id="editLTIText_7_1" value=" " styleClass="ExtraPaddingClass"/>
