...
<table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#EAEAEA" width="100%" id="AutoNumber1" >
 ...
 <h:dataTable id="table"  
                  ...
                  border="0" width="100%" >
        <h:column> 
            <h:commandLink id="viewSections" action="#{listModulesPage.showSections}"  rendered="#{(mdbean.module.moduleshdate.hideFlag == false)}">
 ...
 <h:commandLink id="hideSections" action="#{listModulesPage.hideSections}"  rendered="#{(mdbean.module.moduleshdate.hideFlag == false)}">
      ...
      <h:outputText id="emp_spacemod" value=" "/>
       <h:commandLink id="viewModule"  actionListener="#{listModulesPage.viewModule}" action="#{listModulesPage.redirectToViewModule}"  
          rendered="#{(((mdbean.module.moduleshdate.hideFlag == false)&&(((mdbean.startDate == listModulesPage.nullDate)||(mdbean.startDate <= listModulesPage.currentTimestamp))&&((mdbean.endDate == listModulesPage.nullDate)||(mdbean.endDate >= listModulesPage.currentTimestamp)))))}">
      ...
      <h:commandLink id="viewModule2"  actionListener="#{listModulesPage.viewModule}" action="#{listModulesPage.redirectToViewModule}"  
         rendered="#{((mdbean.module.moduleshdate.hideFlag == false)&&((mdbean.startDate > listModulesPage.currentTimestamp)||(mdbean.endDate < listModulesPage.currentTimestamp)))}">      
         <h:outputText id="title2"
           ...
           <h:dataTable id="tablesec" rendered="#{(((mdbean.moduleId == listModulesPage.showModuleId)||(listModulesPage.expandAllFlag == listModulesPage.trueFlag))&&(mdbean.module.moduleshdate.hideFlag == false))}"
 ...
 <h:outputText id="emp_space" value="   "/>
           ...
           <h:commandLink id="viewSectionEditor"  actionListener="#{listModulesPage.viewSection}" action="#{listModulesPage.redirectToViewSection}" rendered="#{((section.section.contentType == listModulesPage.typeLink)&&((mdbean.startDate == listModulesPage.nullDate)||(mdbean.startDate <= listModulesPage.currentTimestamp))&&((mdbean.endDate == listModulesPage.nullDate)||(mdbean.endDate >= listModulesPage.currentTimestamp)))}">
            ...
            <h:commandLink id="viewSectionEditor2"  actionListener="#{listModulesPage.viewSection}" action="#{listModulesPage.redirectToViewSection}" rendered="#{((section.section.contentType == listModulesPage.typeLink)&&((mdbean.startDate > listModulesPage.currentTimestamp)||(mdbean.endDate < listModulesPage.currentTimestamp)))}">
           ...
           <h:commandLink id="viewSectionLink2"  actionListener="#{listModulesPage.viewSection}" action="#{listModulesPage.redirectToViewSectionLink}" rendered="#{((section.section.contentType != listModulesPage.typeLink)&&((mdbean.startDate > listModulesPage.currentTimestamp)||(mdbean.endDate < listModulesPage.currentTimestamp)))}">
           ...
           <h:column>
               <h:graphicImage id="closed_gif" value="images/closed.gif" alt="#{msgs.list_modules_inst_closed}" rendered="#{((mdbean.module.moduleshdate.hideFlag == false)&&((mdbean.startDate > listModulesPage.currentTimestamp)||(mdbean.endDate < listModulesPage.currentTimestamp)))}" styleClass="ExpClass"/>
           </h:column>
           <h:column>
              <h:outputText id="startDate0" 
                           value="-"    rendered="#{((mdbean.module.moduleshdate.hideFlag == false)&&(mdbean.startDate == listModulesPage.nullDate))}">
            </h:outputText>
                  <h:outputText id="startDate" 
                           value="#{mdbean.startDate}"    rendered="#{((mdbean.module.moduleshdate.hideFlag == false)&&((mdbean.startDate != listModulesPage.nullDate)&&(mdbean.startDate <= listModulesPage.currentTimestamp))&&((mdbean.endDate == listModulesPage.nullDate)||(mdbean.endDate >= listModulesPage.currentTimestamp)))}">
              <f:convertDateTime pattern="yyyy-MMM-d hh:mm a"/>
            </h:outputText>
            <h:outputText id="startDate2" styleClass="italics" 
                           value="#{mdbean.startDate}"     rendered="#{((mdbean.module.moduleshdate.hideFlag == false)&&((mdbean.startDate > listModulesPage.currentTimestamp)||(mdbean.endDate < listModulesPage.currentTimestamp)))}">      
              <f:convertDateTime pattern="yyyy-MMM-d hh:mm a"/>
            </h:outputText>            
           </h:column>
            <h:column>
               <h:outputText id="endDate0" 
                           value="-"    rendered="#{((mdbean.module.moduleshdate.hideFlag == false)&&(mdbean.endDate == listModulesPage.nullDate))}">
              <f:convertDateTime pattern="yyyy-MMM-d hh:mm a"/>
            </h:outputText>
