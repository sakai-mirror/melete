        ...
        <h:messages showDetail="true" showSummary="false" infoClass="BlueClass" errorClass="RedClass"/>     
	     ...
	     <tr>
	       ...
	       <div class="actionBar" align="left">
                <h:commandButton id="continueButton" immediate="true" action="#{addResourcesPage.addItems}" value="#{msgs.im_continue}" tabindex="9" onclick="clearmessage()" accesskey="#{msgs.continue_access}" title="#{msgs.im_continue_text}" styleClass="BottomImgContinue"/>
