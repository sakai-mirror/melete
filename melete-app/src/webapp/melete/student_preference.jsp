          ...
          <td class="maintabledata3" valign="top">
			...
			<tr><td  height="20" class="maintabledata5" ><h:outputText id="t2" value="#{msgs.student_preference_view_select}"  styleClass="tableheader2"/>          </td></tr>
              ...
              <tr>
                <td height="30" >         
                <div align="center">	
                <h:commandButton action="#{studentPreferences.setUserChoice}" value="#{msgs.im_set}" accesskey="#{msgs.im_set_access}" title="#{msgs.im_set_text}" styleClass="BottomImgSpace"/>
			</div></td>
              </tr>
