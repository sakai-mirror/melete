					...
					<tr><td height="20" colspan="2"> 
					 ...
					 <tr><td colspan="2"> &nbsp; </td></tr>	
					     ...
					     <tr>
					          	<td  colspan="2">
					          	<div align="center">
					          		<h:commandButton id="addButton_1" action="#{editSectionPage.setServerUrl}" value="#{msgs.im_continue}" tabindex="" accesskey="#{msgs.continue_access}" title="#{msgs.im_continue_text}" styleClass="BottomImgSpace"/>
	...
	<!-- new link end -->				            		
					...
					<tr>
			            ...
			            <tr>
					          	<td  colspan="2">
					          	<div align="center">
									<h:commandButton id="addButton" action="#{editSectionPage.setServerUrl}" value="#{msgs.im_continue}" tabindex="" accesskey="#{msgs.continue_access}" title="#{msgs.im_continue_text}" styleClass="BottomImgSpace"/>
