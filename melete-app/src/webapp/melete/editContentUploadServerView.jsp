	   ...
	   <table width="100%"  border="1" cellpadding="3" cellspacing="0" bordercolor="#EAEAEA"  style="border-collapse: collapse">
         <tr>
        		...
        		<table width="100%"  border="1" cellpadding="3" cellspacing="0" bordercolor="#EAEAEA"  style="border-collapse: collapse">
					...
					<tr><td>
  					 <h:outputText id="Stext_2" value="#{msgs.editcontentuploadserverview_msg1}"/> 
					...
					<table width="100%" border="0" cellpadding="4" cellspacing="0" bordercolor="#F5F5F5" style="border-collapse: collapse" >
						...
						<tr><td  colspan="2"> 
					     ...
					     <tr>
					          	<td  colspan="2">
					          	<div align="center">
											<h:commandLink id="addButton"  action="#{editSectionPage.setServerFile}" >
		...
		<!-- replace local end -->			            
				...
				<!-- start main -->
			            ...
			            <tr>
					          	<td  colspan="2">
					          	<div align="center">
											<h:commandLink id="addButton_1"  action="#{editSectionPage.setServerFile}" >
