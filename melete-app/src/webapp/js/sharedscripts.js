...
function OpenBookmarkWindow(section_id, section_title, from_page, windowName)
{
  ...
  var _ie = (_info.indexOf("MSIE") > 0 && _info.indexOf("Win") > 0 && _info.indexOf("Windows 3.1") < 0);
	...
	var newWindow;
	if(!_ie) newWindow = window.open('add_bookmark.jsf?sectionId='+section_id+'&sectionTitle='+section_title+'&fromPage='+from_page,windowName,windowDefaults);
	else newWindow = window.open('add_bookmark.jsf?sectionId='+section_id+'&sectionTitle='+section_title+'&fromPage='+from_page,null,windowDefaults);
