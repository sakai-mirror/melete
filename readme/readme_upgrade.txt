/**********************************************************************************
 *
 * $URL: https://source.sakaiproject.org/contrib/etudes/melete/trunk/readme/readme_upgrade.txt $
 * $Id: readme_upgrade.txt 64895 2009-11-24 21:11:55Z rashmi@etudes.org $  
 ***********************************************************************************
 *
...
INSTRUCTIONS TO UPGRADE FROM MELETE 2.6 >> MELETE 2.7.2
For Sakai 2.6.x
-----------------------------------------------------
SETUP INSTRUCTIONS
