...
public class ModuleStudentPrivs implements Serializable,ModuleStudentPrivsService {
    ...
    /** full constructor */
    public ModuleStudentPrivs(String courseId, String studentId, boolean allowUnlimited, boolean deny, Date startDate, Date endDate, org.sakaiproject.component.app.melete.Module module) {
    ...
    /** minimal constructor */
    public ModuleStudentPrivs(String courseId, String studentId, org.sakaiproject.component.app.melete.Module module) {
        this.courseId = courseId;
        this.studentId = studentId;
        this.module = module;
    }
