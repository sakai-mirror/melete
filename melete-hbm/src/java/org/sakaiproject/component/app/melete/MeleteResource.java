...
public class MeleteResource implements Serializable, MeleteResourceService {
    ...
    /** full constructor */
    public MeleteResource( String resourceId, int licenseCode, String ccLicenseUrl, boolean reqAttr, boolean allowCmrcl, int allowMod, int version, org.sakaiproject.component.app.melete.Section section, String copyrightOwner, String copyrightYear) {
