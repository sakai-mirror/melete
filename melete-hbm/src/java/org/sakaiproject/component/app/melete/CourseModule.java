...
public class CourseModule implements Serializable,CourseModuleService {
    ...
    /** full constructor */
    public CourseModule(String courseId, int seqNo, boolean archvFlag, Date dateArchived, boolean deleteFlag, org.sakaiproject.component.app.melete.Module module) {
